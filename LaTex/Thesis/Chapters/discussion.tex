...
%
%1. Summarize findings (some people only read this part)
%-restate the problem (one sentence) and the methods 
%2.Discuss findings, connect to other findings, speculate about reasons
%- "our findings support earlier findings" 
%- "We speculate"
%- "still unknown"
%- Describe the patterns, principles, relationships results show
%3. discuss limits
%-Sense of this section is to establish the domain under which your results are valid, not to question your approach in general
%-Discuss expected criticism of reviewers


%there results are consistent with ...
...
\subsubsection*{Cover and Cluster as important drivers}
