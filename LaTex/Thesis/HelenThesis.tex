...
\def\maintitle {Negative frequency-dependent selection applies also for rewarding species. A combination of natural condition data and agent-based modeling }
